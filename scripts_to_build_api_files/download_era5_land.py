...
def get_unique_months_years(start_date, end_date):    
    ...
    while current_date <= end_date:
        unique_months.add((f"{current_date.month:02d}"))
...
era5_land_dir = './scripts_to_build_api_files/era5_land_raw/'
...
num_threads = 9 # 20 is the max simultainius connections to cds for era5_land, but they may reduce it if its bussy or they decide you are making too many connections
...
file_list = os.listdir(era5_land_dir)
